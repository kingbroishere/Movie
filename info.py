...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002526894663').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://prrajputtt148_db_user:XNRIqkksM9BfJFhW@cluster0.0yyy7ln.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'My_Tg_files')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002991636531'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1003037072038')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002781392044'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002961157691')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002987699696'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002564847154') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003036080399')) # 
...
SHORTENER_API = environ.get("SHORTENER_API", "02ad70a2e761bb14719b3977c7f6c3193db2a5cd")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'shrinkme.io')
SHORTENER_API2 = environ.get("SHORTENER_API2", "02ad70a2e761bb14719b3977c7f6c3193db2a5cd")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'shrinkme.io')
SHORTENER_API3 = environ.get("SHORTENER_API3", "02ad70a2e761bb14719b3977c7f6c3193db2a5cd")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/i5w.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://envs.sh/i5_.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/f4db1c3ad3d9e38b328e6.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/i5_.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
